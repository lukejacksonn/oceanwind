      ...
      case 1:
        switch (i[0]) {
          ...
          case "resize":
            ...
            break;
          case "rounded":
            out["border-radius"] = theme.rounded[""];
            break;
          case "clearfix":
            out["::after"] = {
              content: '""',
      ...
      case 2:
        switch (i[0]) {
          ...
          case "fill":
            ...
            break;
          case "stroke":
            "current" === i[1] ? (out["stroke"] = "currentColor")
      ...
      case 3:
        switch (i[0]) {
          ...
          case "grid":
            switch (i[1]) {
              case "cols":
                out[`grid-template-columns`] = "none" === i[2]
                  ? i[2]
                  : `repeat(${i[2]}, minmax(0, 1fr))`;
                break;
              case "rows":
                out[`grid-template-rows`] = "none" === i[2]
                  ? i[2]
                  : `repeat(${i[2]}, minmax(0, 1fr))`;
                break;
              case "flow":
          ...
          case "border":
            ...
            break;
          case "scale":
            out["transform"] = `scale${i[1].toUpperCase()}(${
              theme.scale[i[2]]
            })`;
            break;
          case "translate":
