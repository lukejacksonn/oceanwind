  ...
  <article className="prose prose-sm sm:prose lg:prose-lg xl:prose-2xl ${ow`mx-auto`}">
    ...
    <blockquote>
      <p>
        ...
        <code>h1</code> elements? How do I disable this? What do you mean I
...
plugins: [],
    ...
    <ol>
      ...
      <li>
        <strong
          >Since we need to have more items, here's another one.</strong
        >
        <ul>
          <li>
      ...
      <li>
        <strong
          >Two items isn't really a list, three is good though.</strong
        >
        <ul>
          <li>
    ...
    <ul>
      ...
      <li>
        <p>
          <strong
            >But in this second top-level list item, they will.</strong
          >
        </p>
        <p>
