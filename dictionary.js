const dictionary = {
  ...
  box: {
    ...
    gen: [/box-(border|content)/, 'box-sizing: $1-box'],
  },

  ...['hidden', 'block', 'flow-root'].reduce(
    (a, x) => ({
      ...a,
      [x]: [new RegExp('(' + x + ')'), 'display: $1'].split(':')],
    }),
    {}
  ),
};
...
[['skew', 'x', '$skewscale'], ['transform', 'skewX($2deg)']],
[['', 'skew', 'x', '$skewscale'], ['transform', 'skewX(-$2deg)']],
[['skew', 'y', '$skewscale'], ['transform', 'skewY($2)']],
[['', 'skew', 'y', '$skewscale'], ['transform', 'skewY(-$2deg)']],
...
[['origin', '$word', '$word'],['transform-origin', '$1 $2']],
[['origin', '$word'],['transform-origin', '$1']],
...
[['pointer', 'events', '$word'], ['pointer-events', '$2']],
